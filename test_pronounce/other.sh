...
time ./test_pronounce -dict /Users/test/Downloads/sourceFiltered_exp3Mar22.dict \
                        ...
                        -infolder /Users/test/Downloads/train/scrape/other/other/ \
                        -tests /Users/test/Downloads/train/scrape/other/other/other_input.csv \
                        -expectations /Users/test/Downloads/train/scrape/other/other/other_expectations.csv \
...
echo
echo "clean up"
rm /Users/test/Downloads/train/scrape/other/other/*_fixed*.wav                        
echo
date
echo
echo
