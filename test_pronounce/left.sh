...
time ./test_pronounce -dict /Users/test/Downloads/sourceFiltered_exp3Mar22.dict \
                        ...
                        -infolder /Users/test/Downloads/train/SpeechCommands/left/left/ \
                        -tests /Users/test/Downloads/train/SpeechCommands/left/left/left_input.csv \
                        -expectations /Users/test/Downloads/train/SpeechCommands/left/left/left_expectations.csv \
...
echo
echo "clean up"
rm /Users/test/Downloads/train/SpeechCommands/left/left/*_fixed*.wav                        
echo
date
echo
echo
