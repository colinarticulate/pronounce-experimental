...
time ./test_pronounce -dict /Users/test/Downloads/sourceFiltered_exp2.dict \
                        ...
                        -infolder /Users/test/Downloads/train/SpeechCommands/cat/cat/ \
                        -tests /Users/test/Downloads/train/SpeechCommands/cat/cat/cat_input.csv \
                        -expectations /Users/test/Downloads/train/SpeechCommands/cat/cat/cat_expectations.csv \
...
echo
echo "clean up"
rm /Users/test/Downloads/train/SpeechCommands/cat/cat/*_fixed*.wav                        
echo
date
echo
echo
