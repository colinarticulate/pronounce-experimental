...
time ./test_pronounce -dict /Users/test/Downloads/sourceFiltered_exp3Mar22.dict \
                        ...
                        -infolder /Users/test/Downloads/train/scrape/i/i/ \
                        -tests /Users/test/Downloads/train/scrape/i/i/i_input.csv \
                        -expectations /Users/test/Downloads/train/scrape/i/i/i_expectations.csv \
...
echo
echo "clean up"
rm /Users/test/Downloads/train/scrape/i/i/*_fixed*.wav                        
echo
date
echo
echo
