...
time ./test_pronounce -dict /Users/test/Downloads/sourceFiltered_exp3Mar22.dict \
                        ...
                        -infolder /Users/test/Downloads/train/mswc/follow/follow/ \
                        -tests /Users/test/Downloads/train/mswc/follow/follow/follow_input.csv \
                        -expectations /Users/test/Downloads/train/mswc/follow/follow/follow_expectations.csv \
...
echo
echo "clean up"
rm /Users/test/Downloads/train/mswc/follow/follow/*_fixed*.wav                        
echo
date
echo
echo
