...
time ./test_pronounce -dict /Users/test/Downloads/sourceFiltered_exp3Mar22.dict \
                        ...
                        -infolder /Users/test/Downloads/train/SpeechCommands/down/down/ \
                        -tests /Users/test/Downloads/train/SpeechCommands/down/down/down_input.csv \
                        -expectations /Users/test/Downloads/train/SpeechCommands/down/down/down_expectations.csv \
...
echo
echo "clean up"
rm /Users/test/Downloads/train/SpeechCommands/down/down/*_fixed*.wav                        
echo
date
echo
echo
