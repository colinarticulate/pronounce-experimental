...
time ./test_pronounce -dict /Users/test/Downloads/sourceFiltered_exp3Mar22.dict \
                        ...
                        -infolder /Users/test/Downloads/train/SpeechCommands/no/no/ \
                        -tests /Users/test/Downloads/train/SpeechCommands/no/no/no_input.csv \
                        -expectations /Users/test/Downloads/train/SpeechCommands/no/no/no_expectations.csv \
...
echo
echo "clean up"
rm /Users/test/Downloads/train/SpeechCommands/no/no/*_fixed*.wav                        
echo
date
echo
echo
