...
time ./test_pronounce -dict /Users/test/Downloads/sourceFiltered_exp3Mar22.dict \
                        ...
                        -infolder /Users/test/Downloads/train/us_female_vowels/hood_uh/hood \
                        -tests /Users/test/Downloads/train/us_female_vowels/hood_uh/hood/fv_hood_input.csv \
                        -expectations /Users/test/Downloads/train/us_female_vowels/hood_uh/hood/fv_hood_expectations.csv \
...
echo
echo "clean up"
rm /Users/test/Downloads/train/us_female_vowels/hood_uh/hood/*_fixed*.wav                        
echo
date
echo
echo
