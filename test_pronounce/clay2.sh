...
time ./test_pronounce -dict /Users/test/Downloads/sourceFiltered_exp3Mar22.dict \
                        ...
                        -infolder /Users/test/Downloads/train/scrape/clay/clay/ \
                        -tests /Users/test/Downloads/train/scrape/clay/clay/clay_input.csv \
                        -expectations /Users/test/Downloads/train/scrape/clay/clay/clay_expectations.csv \
...
echo
echo "clean up"
rm /Users/test/Downloads/train/scrape/clay/clay/*_fixed*.wav                        
echo
date
echo
echo
