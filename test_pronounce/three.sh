...
time ./test_pronounce -dict /Users/test/Downloads/sourceFiltered_exp3Mar22.dict \
                        ...
                        -infolder /Users/test/Downloads/train/SpeechCommands/three/three/ \
                        -tests /Users/test/Downloads/train/SpeechCommands/three/three/three_input.csv \
                        -expectations /Users/test/Downloads/train/SpeechCommands/three/three/three_expectations.csv \
...
echo
echo "clean up"
rm /Users/test/Downloads/train/SpeechCommands/three/three/*_fixed*.wav                        
echo
date
echo
echo
