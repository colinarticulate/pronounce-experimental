...
time ./test_pronounce -dict /Users/test/Downloads/sourceFiltered_exp3Mar22.dict \
                        ...
                        -infolder /Users/test/Downloads/train/scrape/scrape8/scrape8 \
                        -tests /Users/test/Downloads/train/scrape/scrape8/scrape8/scrape8_train_input.csv \
                        -expectations /Users/test/Downloads/train/scrape/scrape8/scrape8/scrape8_train_expectations.csv \
...
echo
echo "clean up"
rm /Users/test/Downloads/train/scrape/scrape8/scrape8/*_fixed*.wav                        
echo
date
echo
echo
