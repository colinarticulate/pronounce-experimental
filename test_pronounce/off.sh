...
time ./test_pronounce -dict /Users/test/Downloads/sourceFiltered_exp3Mar22.dict \
                        ...
                        -infolder /Users/test/Downloads/train/SpeechCommands/off/off/ \
                        -tests /Users/test/Downloads/train/SpeechCommands/off/off/off_input.csv \
                        -expectations /Users/test/Downloads/train/SpeechCommands/off/off/off_expectations.csv \
...
echo
echo "clean up"
rm /Users/test/Downloads/train/SpeechCommands/off/off/*_fixed*.wav                        
echo
date
echo
echo
