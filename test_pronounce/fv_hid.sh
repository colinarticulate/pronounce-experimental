...
time ./test_pronounce -dict /Users/test/Downloads/sourceFiltered_exp3Mar22.dict \
                        ...
                        -infolder /Users/test/Downloads/train/us_female_vowels/hid_ih/hid/ \
                        -tests /Users/test/Downloads/train/us_female_vowels/hid_ih/hid/fv_hid_input.csv \
                        -expectations /Users/test/Downloads/train/us_female_vowels/hid_ih/hid/fv_hid_expectations.csv \
...
echo
echo "clean up"
rm /Users/test/Downloads/train/us_female_vowels/hid_ih/hid/*_fixed*.wav                        
echo
date
echo
echo
