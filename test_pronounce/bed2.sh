...
time ./test_pronounce -dict /Users/test/Downloads/sourceFiltered_exp3Mar22.dict \
                        ...
                        -infolder /Users/test/Downloads/train/scrape/bed2/bed2/ \
                        -tests /Users/test/Downloads/train/scrape/bed2/bed2/bed2_input.csv \
                        -expectations /Users/test/Downloads/train/scrape/bed2/bed2/bed2_expectations.csv \
...
echo
echo "clean up"
rm /Users/test/Downloads/train/scrape/bed2/bed2/*_fixed*.wav                        
echo
date
echo
echo
