...
time ./test_pronounce -dict /Users/test/Downloads/sourceFiltered_exp3Mar22.dict \
                        ...
                        -infolder /Users/test/Downloads/train/SpeechCommands/tree/tree/ \
                        -tests /Users/test/Downloads/train/SpeechCommands/tree/tree/tree_input.csv \
                        -expectations /Users/test/Downloads/train/SpeechCommands/tree/tree/tree_expectations.csv \
...
echo
echo "clean up"
rm /Users/test/Downloads/train/SpeechCommands/tree/tree/*_fixed*.wav                        
echo
date
echo
echo
