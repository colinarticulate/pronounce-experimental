...
time ./test_pronounce -dict /Users/test/Downloads/sourceFiltered_exp3Mar22.dict \
                        ...
                        -infolder /Users/test/Downloads/train/us_female_vowels/heed_iy/ \
                        -tests /Users/test/Downloads/train/us_female_vowels/heed_iy/fv_heed_input.csv \
                        -expectations /Users/test/Downloads/train/us_female_vowels/heed_iy/fv_heed_expectations.csv \
...
echo
echo "clean up"
rm /Users/test/Downloads/train/us_female_vowels/heed_iy/*_fixed*.wav                        
echo
date
echo
echo
