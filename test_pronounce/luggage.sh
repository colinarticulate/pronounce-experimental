...
time ./test_pronounce -dict /Users/test/Downloads/sourceFiltered_exp3Mar22.dict \
                        ...
                        -infolder /Users/test/Downloads/train/scrape/luggage/luggage/ \
                        -tests /Users/test/Downloads/train/scrape/luggage/luggage/luggage_input.csv \
                        -expectations /Users/test/Downloads/train/scrape/luggage/luggage/luggage_expectations.csv \
...
echo
echo "clean up"
rm /Users/test/Downloads/train/scrape/luggage/luggage/*_fixed*.wav                        
echo
date
echo
echo
