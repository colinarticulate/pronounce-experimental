...
time ./test_pronounce -dict /Users/test/Downloads/sourceFiltered_exp2.dict \
                        ...
                        -infolder /Users/test/Downloads/train/SpeechCommands/dog/dog/ \
                        -tests /Users/test/Downloads/train/SpeechCommands/dog/dog/dog_input.csv \
                        -expectations /Users/test/Downloads/train/SpeechCommands/dog/dog/dog_expectations.csv \
...
echo
echo "clean up"
rm /Users/test/Downloads/train/SpeechCommands/dog/dog/*_fixed*.wav                        
echo
date
echo
echo
