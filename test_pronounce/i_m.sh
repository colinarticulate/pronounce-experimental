...
time ./test_pronounce -dict /Users/test/Downloads/sourceFiltered_exp3Mar22.dict \
                        ...
                        -infolder /Users/test/Downloads/train/scrape/i_m/ok \
                        -tests /Users/test/Downloads/train/scrape/i_m/ok/i_m_input.csv \
                        -expectations /Users/test/Downloads/train/scrape/i_m/ok/i_m_expectations.csv \
...
echo
echo "clean up"
rm /Users/test/Downloads/train/scrape/i_m/ok/*_fixed*.wav                        
echo
date
echo
echo
