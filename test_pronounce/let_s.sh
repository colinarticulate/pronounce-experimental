...
time ./test_pronounce -dict /Users/test/Downloads/sourceFiltered_exp3Mar22.dict \
                        ...
                        -infolder /Users/test/Downloads/train/scrape/let_s/ok \
                        -tests /Users/test/Downloads/train/scrape/let_s/ok/let_s_input.csv \
                        -expectations /Users/test/Downloads/train/scrape/let_s/ok/let_s_expectations.csv \
...
echo
echo "clean up"
rm /Users/test/Downloads/train/scrape/let_s/ok/*_fixed*.wav                        
echo
date
echo
echo
