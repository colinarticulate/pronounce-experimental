...
time ./test_pronounce -dict /Users/test/Downloads/sourceFiltered_exp3Mar22.dict \
                        ...
                        -infolder /Users/test/Downloads/train/us_female_vowels/head_eh/ \
                        -tests /Users/test/Downloads/train/us_female_vowels/head_eh/fv_head_input.csv \
                        -expectations /Users/test/Downloads/train/us_female_vowels/head_eh/fv_head_expectations.csv \
...
echo
echo "clean up"
rm /Users/test/Downloads/train/us_female_vowels/head_eh/*_fixed*.wav                        
echo
date
echo
echo
