...
time ./test_pronounce -dict /Users/test/Downloads/sourceFiltered_exp3Mar22.dict \
                        ...
                        -infolder /Users/test/Downloads/train/SpeechCommands/go/go/ \
                        -tests /Users/test/Downloads/train/SpeechCommands/go/go/go_input.csv \
                        -expectations /Users/test/Downloads/train/SpeechCommands/go/go/go_expectations.csv \
...
echo
echo "clean up"
rm /Users/test/Downloads/train/SpeechCommands/go/go/*_fixed*.wav                        
echo
date
echo
echo
