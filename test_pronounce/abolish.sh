...
time ./test_pronounce -dict /Users/test/Downloads/sourceFiltered_exp3Mar22.dict \
                        ...
                        -infolder /Users/test/Downloads/train/scrape/abolish/abolish/ \
                        -tests /Users/test/Downloads/train/scrape/abolish/abolish/abolish_input.csv \
                        -expectations /Users/test/Downloads/train/scrape/abolish/abolish/abolish_expectations.csv \
...
echo
echo "clean up"
rm /Users/test/Downloads/train/scrape/abolish/abolish/*_fixed*.wav                        
echo
date
echo
echo
