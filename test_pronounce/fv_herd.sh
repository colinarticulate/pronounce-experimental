...
time ./test_pronounce -dict /Users/test/Downloads/sourceFiltered_exp3Mar22.dict \
                        ...
                        -infolder /Users/test/Downloads/train/us_female_vowels/herd_er/ \
                        -tests /Users/test/Downloads/train/us_female_vowels/herd_er/fv_herd_input.csv \
                        -expectations /Users/test/Downloads/train/us_female_vowels/herd_er/fv_herd_expectations.csv \
...
echo
echo "clean up"
rm /Users/test/Downloads/train/us_female_vowels/herd_er/*_fixed*.wav                        
echo
date
echo
echo
