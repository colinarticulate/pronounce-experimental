...
time ./test_pronounce -dict /Users/test/Downloads/sourceFiltered_exp3Mar22.dict \
                        ...
                        -infolder /Users/test/Downloads/train/scrape/luggage/luggage_train/ \
                        -tests /Users/test/Downloads/train/scrape/luggage/luggage_train/luggage_train_input.csv \
                        -expectations /Users/test/Downloads/train/scrape/luggage/luggage_train/luggage_train_expectations.csv \
...
echo
echo "clean up"
rm /Users/test/Downloads/train/scrape/luggage/luggage_train/*_fixed*.wav                        
echo
date
echo
echo
