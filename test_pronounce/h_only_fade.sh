...
time ./test_pronounce -dict /Users/test/Downloads/sourceFiltered_exp3Mar22.dict \
                        ...
                        -infolder /Users/test/Downloads/train/scrape/consonants/h_fade \
                        -tests /Users/test/Downloads/train/scrape/consonants/h_fade/h_input.csv \
                        -expectations /Users/test/Downloads/train/scrape/consonants/h_fade/h_expectations.csv \
...
echo
echo "clean up"
rm /Users/test/Downloads/train/scrape/consonants/h_fade/*_fixed*.wav                        
echo
date
echo
echo
