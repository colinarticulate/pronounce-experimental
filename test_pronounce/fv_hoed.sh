...
time ./test_pronounce -dict /Users/test/Downloads/sourceFiltered_exp3Mar22.dict \
                        ...
                        -infolder /Users/test/Downloads/train/us_female_vowels/hoed_ow/hoed/ \
                        -tests /Users/test/Downloads/train/us_female_vowels/hoed_ow/hoed/fv_hoed_input.csv \
                        -expectations /Users/test/Downloads/train/us_female_vowels/hoed_ow/hoed/fv_hoed_expectations.csv \
...
echo
echo "clean up"
rm /Users/test/Downloads/train/us_female_vowels/hoed_ow/hoed/*_fixed*.wav                        
echo
date
echo
echo
