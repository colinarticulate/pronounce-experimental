...
time ./test_pronounce -dict /Users/test/Downloads/sourceFiltered_exp3Mar22.dict \
                        ...
                        -infolder /Users/test/Downloads/train/SpeechCommands/nine/nine/ \
                        -tests /Users/test/Downloads/train/SpeechCommands/nine/nine/nine_input.csv \
                        -expectations /Users/test/Downloads/train/SpeechCommands/nine/nine/nine_expectations.csv \
...
echo
echo "clean up"
rm /Users/test/Downloads/train/SpeechCommands/nine/nine/*_fixed*.wav                        
echo
date
echo
echo
