...
time ./test_pronounce -dict /Users/test/Downloads/sourceFiltered_exp3Mar22.dict \
                        ...
                        -infolder /Users/test/Downloads/train/SpeechCommands/zero/zero/ \
                        -tests /Users/test/Downloads/train/SpeechCommands/zero/zero/zero_input.csv \
                        -expectations /Users/test/Downloads/train/SpeechCommands/zero/zero/zero_expectations.csv \
...
echo
echo "clean up"
rm /Users/test/Downloads/train/SpeechCommands/zero/zero/*_fixed*.wav                        
echo
date
echo
echo
