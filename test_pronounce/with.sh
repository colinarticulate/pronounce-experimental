...
time ./test_pronounce -dict /Users/test/Downloads/sourceFiltered_exp3Mar22.dict \
                        ...
                        -infolder /Users/test/Downloads/train/scrape/with/with/ \
                        -tests /Users/test/Downloads/train/scrape/with/with/with_input.csv \
                        -expectations /Users/test/Downloads/train/scrape/with/with/with_expectations.csv \
...
echo
echo "clean up"
rm /Users/test/Downloads/train/scrape/with/with/*_fixed*.wav                        
echo
date
echo
echo
