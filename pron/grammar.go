...
const (
	...
	r_p  = "<p>"
	r_r  = "<r>"
	r_ss = "<ss>" // This really an s phoneme
	r_sh = "<sh>"
	//r_st = "<st>"
	r_sil = "<sil>"
	r_t   = "<t>"
...
var consonantsByGroup = map[consonantGroup][]phoneme{
	...
	alveolar: {
		//d, l, n, s, st, t, z, r, nd, dz, ts, axn, axl, axm,
		//d, l, n, s, t, z, r, dz, ts, axn, axl, uwl, sts,
		d, l, n, s, t, z, r, dz, ts,
	},
	post_alveolar: {
		//sh, zh,
...
func (g *jsgfGrammar) new_R_Vx(exceptPhons ...phoneme) R_Vx {
	...
	r := g.new_R_named(name, func() rule {
		vowels := map[phoneme]bool{
			//aa: true, ae: true, ah: true, ao: true, aw: true, ax: true, ay: true, eh: true, ehr: true, er: true, ey: true, ih: true, iy: true, oh: true, ow: true, oy: true, uw: true, uh: true, y: true, axnoise: true, ernoise: true, axl: true, axm: true, axn: true, uwn: true, uwl: true, uwm: true,
			...
			// aa: true, ae: true, ah: true, ao: true, aw: true, ax: true, ay: true, eh: true, ehr: true, er: true, ey: true, ih: true, iy: true, oh: true, ow: true, oy: true, uw: true, uh: true, y: true, axl: true, axm: true, axn: true, uwn: true, uwl: true, uwm: true,
		}
...
func (g *jsgfGrammar) new_R_noSlide_X(exceptPhons ...phoneme) R_V_noSlide_X {
	...
	r := g.new_R_named(name, func() rule {
		noSlideVowels := map[phoneme]bool{
			//aa: true, ae: true, ah: true, ao: true, ax: true, eh: true, ehr: true,  er: true, ih: true, iy: true, oh: true, uw: true, uh: true, y: true, axnoise: true, ernoise: true, axl: true, axm: true, axn: true, uwn: true, uwl:  true, uwm: true,
			...
			// aa: true, ae: true, ah: true, ao: true, ax: true, eh: true, ehr: true,  er: true, ih: true, iy: true, oh: true, uw: true, uh: true, y: true, axl: true, axm: true, axn: true, uwn: true, uwl:  true, uwm: true,
		}
...
func (g *jsgfGrammar) new_R_V_noSlide() R_V_noSlide {
	...
	r := g.new_R_named(name, func() rule {
		noSlideVowels := []phoneme{
			...
			aa, ae, ah, eh, ehr, er, ih, iy, oh, uw, uh, y,  
		}
		phons := []rule{}
...
func (gr *jsgfGrammar) new_R_C() R_C {
	...
	r := gr.new_R_named(name, func() rule {
		consonants := []phoneme{
			...
			// b, ch, d, dh, f, g, hh, jh, k, l, m, n, p, r, s, sh, t, th, v, w, z, zh, st, nd, dz, ts, axm, axn, axl, kw, ks,
			//b, ch, d, dh, f, g, hh, jh, k, l, m, n, p, r, s, sh, t, th, v, w, z, zh, dz, ts, axn, axl, kw, ks, uwl, sts,
...
func (j *jsgfStandard) openingPenalty(ph phoneme) (phonRule, bool) {
	...
	//penalties := consRemove(newConsonants(), b, ch, d, dh, f, "g", hh, jh, k, l, m, n, ng, p, r, s, sh, t, th, v, w, z, zh, dz, ts, axl, axn, kw, ks, uwl, sts)  // remove everything
	...
	//penalties := consRemove(newConsonants(), hh, f, m, v, r, w, l, y, sh, k, zh, dh, ng, n, jh, b, p, g, th, ph)     // allowing HH in the opening run is useful for many things BUT, messes up eh-school (turning ae into ih)
...
var confusionMatrix = map[phoneme]map[phoneme]float64{
	...
	t: {
		p: 24.6, t: 95, k: 12.5, f: 7.7, th: 9.2, s: 4, sh: 2.7, ch: 5, hh: 11.3, b: 7.1, d: 20.4, g: 5, v: 2, dh: 5.4, z: 3.7, zh: 0.5, jh: 5, y: 1.5, m: 2.1, n: 3.3, ng: 2, l: 2.4, r: 0.8, w: 1, oy: 0.5, ao: 0.5, aa: 0.5,
		  },     //t:ng should be ok, but it seems to fail. Especially if t is in the last position, eg coat/caught
	k: {
	...
	m: {
		p: 3.8, t: 9.2, k: 2.5, f: 2.9, th: 4.6, s: 1.7, sh: 0.8, ch: 0.7, hh: 3.9, b: 9.6, d: 5.8, g: 1.5, v: 7.3, dh: 2.1, z: 1.5, zh: 1.2, jh: 2.4, y: 0.9, m: 100, n: 20, ng: 10.8, l: 11.7, r: 5.4, w: 4.2,
		  },
	n: {
	...
	ng: {
		p: 0, t: 6.7, k: 0.4, f: 2.1, th: 0.5, s: 0.5, sh: 0.5, ch: 0.5, hh: 0, b: 2.5, d: 5.8, g: 6.3, v: 1.9, dh: 1.7, z: 0.5, zh: 0.5, jh: 0.5, y: 0, m: 13.8, n: 35, ng: 60, l: 2.1, r: 1.7, w: 10,
		  },
	// keeep out for uwl, axl added 2nd Jan 2022 - PE
	l: {
	...
	eh: {
		p: 26.3, t: 7.9, k: 12.1, f: 11.3, th: 5, s: 0.5, sh: 0.5, ch: 0.5, hh: 99, b: 14.6, d: 6.7, g: 4.9, v: 6.6, dh: 1.7, z: 2.5, zh: 0.5, jh: 0.5, y: 0.5, m: 4.1, n: 4.1, ng: 1, l: 14.8, r: 96, w: 1, oy: 0.5,
		  },
	ae: {
	...
	aa: {
		p: 26.3, t: 7.9, k: 12.1, f: 11.3, th: 5, s: 0.8, sh: 0.4, ch: 0.9, hh: 99, b: 3, d: 6.7, g: 4.9, v: 6.6, dh: 1.7, z: 0.5, zh: 0.4, jh: 0.5, y: 0.5, m: 3.6, n: 2.9, ng: 0.5, l: 14.8, r: 96, w: 6.7,
		  },
	ah: {
		p: 26.3, t: 7.9, k: 12.1, f: 11.3, th: 5, s: 0.8, sh: 0.4, ch: 0.9, hh: 99, b: 14.6, d: 6.7, g: 4.9, v: 6.6, dh: 3, z: 0.5, zh: 0.4, jh: 0.5, y: 0.5, m: 3.6, n: 5, ng: 10, l: 14.8, r: 96, w: 6.7,
		  },
	ao: {
	...
	uh: {
		p: 26.3, t: 4.6, k: 12.1, f: 11.3, th: 5, s: 0.4, sh: 0.4, ch: 0.8, hh: 99, b: 8.3, d: 1.3, g: 0.4, v: 4.6, dh: 1.7, z: 0.4, zh: 0, jh: 1, y: 0.8, m: 0, n: 0.8, ng: 0, l: 1.7, r: 0.8, w: 0.4,
		  },
	uw: {
		p: 1.7, t: 2, k: 2, f: 1.2, th: 2, s: 1.2, sh: 0, ch: 0.5, hh: 1.7, b: 5.8, d: 2, g: 3, v: 2.1, dh: 2, z: 0.5, zh: 0.5, jh: 0.5, y: 5.0, m: 5.8, n: 2, ng: 10, l: 2.5, r: 4.2, w: 99,
		  },
	ay: {
	...
	aw: {
		p: 2.5, t: 7.9, k: 1.7, f: 0.5, th: 0.5, s: 0.8, sh: 0.4, ch: 0.5, hh: 5.8, b: 0.5, d: 0.5, g: 4.9, v: 0.5, dh: 0.8, z: 0.5, zh: 0.4, jh: 0.5, y: 4.6, m: 3.6, n: 2.1, ng: 10, l: 14.8, r: 96, w: 6.7, oy:0.5,
		  },
	er: {
	...
	// Adding keep outs for axn, axm, axl -- 2nd Jan 2022
	ax: {
	...
	oh: {
		p: 26.3, t: 7.9, k: 12.1, f: 11.3, th: 5, s: 0.8, sh: 0.4, ch: 0.9, hh: 99, b: 3, d: 6.7, g: 4.9, v: 6.6, dh: 1.7, z: 0.5, zh: 0.4, jh: 0.5, y: 0.5, m: 3.6, n: 2.9, ng: 0.5, l: 14.8, r: 96, w: 6.7, aa: 99, ah: 99,
		  },
	// Added 8th March 2021 to allow testing of new training model that include this phoneme - using eh figures to get started ... will need teweeking at some point (possibly combine with r ???)
	ehr: {
		p: 26.3, t: 7.9, k: 12.1, f: 11.3, th: 5, s: 0.5, sh: 0.5, ch: 0.5, hh: 99, b: 14.6, d: 6.7, g: 4.9, v: 6.6, dh: 1.7, z: 2.5, zh: 0.5, jh: 0.5, y: 0.5, m: 4.1, n: 4.1, ng: 1, l: 14.8, r: 96, w: 1, oy: 0.5,
		  },
	...
	// These are a first order guess ...
	// Based on using the dominant axL, axM, axN, kS, Kw, dZ, tS
	// eg axL is based on L
	axl: {
		p: 5.8, t: 8.3, k: 1.7, f: 5.8, th: 3.3, s: 2, sh: 0.5, ch: 1.2, hh: 2.1, b: 8.3, d: 2, g: 3.6, v: 8.7, dh: 3.3, z: 2.5, zh: 2.5, jh: 4, y: 1.8, m: 10, n: 1.1, ng: 3.0, l: 99, r: 4.2, w: 5.4, ax: 99, axn: 99, axm: 99, axl: 99, uwn: 99, uwm: 99, uwl: 99,
		  },
	...
	*/  	
	//Updating the relationship between axm, axm and .... m, n, ng   ....... 2nd Jan 2022 PE
	axm: {
		p: 3.8, t: 9.2, k: 2.5, f: 2.9, th: 4.6, s: 1.7, sh: 0.8, ch: 0.7, hh: 3.9, b: 9.6, d: 5.8, g: 1.5, v: 7.3, dh: 2.1, z: 1.5, zh: 1.2, jh: 2.4, y: 0.9, m: 100, n: 100, ng: 100, l: 11.7, r: 5.4, w: 4.2, ax: 99, axn: 99, axm: 99, axl: 99, uwn: 99, uwm: 99,
		  },
	axn: {
		p: 1.6, t: 9.6, k: 0.6, f: 1, th: 1.6, s: 0.9, sh: 0.3, ch: 0.3, hh: 3.2, b: 1.7, d: 8.3, g: 1.9, v: 4.5, dh: 2.1, z: 3.8, zh: 0.3, jh: 0.3, y: 1.2, m: 100, n: 100, ng: 100, l: 17.5, r: 4, w: 1.8, ax: 99, axn: 99, axm: 99, axl: 99, uwn: 99, uwm: 99,
		  },
...
func (j *jsgfStandard) vowelHandler(ph phoneme) []phoneme {
	...
	if len(v_x) == 0 {
		...
		vowels := []phoneme{
			//aa, ae, ah, ao, aw, ax, ay, eh, er, ey, ih, iy, oh, ow, oy, uw, uh, y, axnoise, ernoise, axl, axm, axn, uwl, uwn, uwm,
		    aa, ae, ah, ao, aw, ax, ay, eh, er, ey, ih, iy, oh, ow, oy, uw, uh, y, axl, axm, axn, uwl, uwn, uwm, axr,
			// aa, ae, ah, ao, aw, ax, ay, eh, er, ey, ih, iy, oh, ow, oy, uw, uh, y, axl, axm, axn, uwl, uwn, uwm,
		}
