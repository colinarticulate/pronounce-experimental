...
func mock_continuous(result []string) {

	result[0] = "sil ax l aw d sil*-2689*sil,0,20*ax,21,42*l,43,55*aw,56,119*d,120,133*sil,134,197**"
}
...
func Ps_plus_call(arg1 []byte, arg2 []byte, arg3 []string) []Utt {
	...
	//mock_continuous(result)
	elapsed := time.Since(start)
	//fmt.Printf("continuous: %s\t%s\n", elapsed, result[0])
	...
	if strings.Contains(result[0], "**") {
		...
		fmt.Println("continuous: ", elapsed, "\t", utts)
		return utts
	} else {
		return nil
	}
...
func batch_mock(result []string) {
	result[0] = "54.97,4.93,-7.22,5.18,-1.72,9.32,-4.26,-18.37,-17.32,-6.05,2.84,1.84,-1.61,*"
}
...
func Ps_batch_plus_call(arg2 []byte, arg3 []string) []string {
	...
	if strings.Contains(result[0], ",*") {
		...
		fmt.Println("batch: ", elapsed, "\t", numbers)
